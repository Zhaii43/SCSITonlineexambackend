...
from .views import (
    ...
    list_enrolled_students, add_enrolled_student, delete_enrolled_student, update_enrolled_student,
    import_enrolled_students_csv, download_enrolled_template, sync_masterlist_accounts,
    list_import_history, update_import_email_delivery, delete_import_history_item, bulk_delete_import_history,
...
urlpatterns = [
    ...
    path('enrolled-records/import-history/', list_import_history, name='list_import_history'),
    path('enrolled-records/import-history/delete/', bulk_delete_import_history, name='bulk_delete_import_history'),
    path('enrolled-records/import-history/<int:import_id>/delete/', delete_import_history_item, name='delete_import_history_item'),
    path('enrolled-records/import-history/<int:import_id>/email-status/', update_import_email_delivery, name='update_import_email_delivery'),
    path('enrolled-records/template/', download_enrolled_template, name='download_enrolled_template'),
    path('enrolled-records/<int:record_id>/update/', update_enrolled_student, name='update_enrolled_student'),
