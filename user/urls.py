...
from .views import (
    ...
    request_password_reset, request_password_reset_direct, reset_password, validate_reset_token, verify_reset_code,
    ...
    request_email_change, resend_email_change_otp, verify_email_change,
